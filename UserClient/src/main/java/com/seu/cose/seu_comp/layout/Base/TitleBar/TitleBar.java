package com.seu.cose.seu_comp.layout.Base.TitleBar;
...
import com.seu.cose.seu_comp.layout.Base.TitleBar.style.TitleBarLightStyle;
import com.seu.cose.seu_comp.layout.Base.TitleBar.style.TitleBarNightStyle;
import com.seu.cose.seu_comp.layout.Base.TitleBar.style.TitleBarTransparentStyle;
...
public class TitleBar extends FrameLayout
     ...
     * 设置左边可见性
     */
    public void setLeftInvisible(boolean isVisible) {
//        mLeftView.setEnabled(isVisible);
        mLeftView.setVisibility(isVisible ? VISIBLE : INVISIBLE);
    }

    /**
     * 设置右边可见性
     */
    public void setRightInvisible(boolean isVisible){
        mRightView.setVisibility(isVisible ? VISIBLE : INVISIBLE);
    }
